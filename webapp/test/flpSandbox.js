		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Test a signature pad component",
									"targetURL": "#projectsignaturepadsignaturepadproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectsignaturepadsignaturepadproject-display": {
								"semanticObject": "projectsignaturepadsignaturepadproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectsignaturepad.signaturepadproject",
									"url": sap.ui.require.toUrl("projectsignaturepad/signaturepadproject")
								}
							}
						}
					}
